...
| 16–17 | Journal d'audit | Utilisateur, date/heure, action, élément, ancienne/nouvelle valeur, motif, IP. **Ajout seul** (triggers PostgreSQL) et **chaîné par hachage SHA-256** : bouton « Vérifier l'intégrité » détecte toute altération directe en base. Aucune suppression physique des paiements, dépenses, caisses et mouvements de stock |
